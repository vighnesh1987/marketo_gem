...
module Rapleaf
  module Marketo
    ...
    def self.new_client(access_key, secret_key, options = {})
      # Parse options
      api_subdomain = options[:api_subdomain] || 'na-i'
      api_version = options[:api_version] || '1_5'
      endpoint = options[:endpoint] || "https://#{api_subdomain}.marketo.com/soap/mktows/#{api_version}"
      document_version = options[:document_version] || '1_4'
